...
public class FaturamentoImovelBO {
	...
	public void preDeterminarFaturamentoImovel(FaturamentoImovelTO faturamentoTO) throws Exception {
		...
		if (imovel.possuiLigacaoAguaAtiva() || imovel.possuiLigacaoEsgotoAtiva() || imovel.possuiHidrometro()) {
	...
	public boolean possuiSituacaoEspecialFaturamento(Imovel imovel, Integer anoMesFaturamento) {
		List<FaturamentoSituacaoHistorico> faturamentosSituacaoHistorico = faturamentoSituacaoRepositorio.pesquisarFaturamentosHistoricoVigentes(imovel.getId());
