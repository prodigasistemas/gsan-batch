...
public class ArquivoTextoTipo01 {
    ...
    public String build() {
        ...
        builder.append(Utilitarios.completaComEspacosADireita(25, imovel.getLocalidade().getGerenciaRegional().getNome()));
        builder.append(Utilitarios.completaComEspacosADireita(25, imovel.getLocalidade().getDescricao()));
        ...
        builder.append(Utilitarios.completaComEspacosADireita(17, imovel.getInscricaoFormatadaSemPonto()));

        builder.append(Utilitarios.completaComEspacosADireita(70, imovel.getEnderecoFormatadoAbreviado()));
        ...
        builder.append(Utilitarios.completaComEspacosADireita(1, imovel.getPocoTipo()));
        ...
        builder.append(Utilitarios.completaComEspacosADireita(120, extratoQuitacaoBO.obterMsgQuitacaoDebitos(imovel.getId(), anoMesReferencia)));
        ...
        builder.append(Utilitarios.formataData(
        ...
        builder.append(faturamentoSituacaoBO.verificarParalisacaoFaturamentoAgua(imovel, anoMesReferencia).getId());
        builder.append(faturamentoSituacaoBO.verificarParalisacaoFaturamentoEsgoto(imovel, anoMesReferencia).getId());
	...
	private void buildDadosCliente() {
	...
	private void buildInformacoesConta() {
		escreverVencimentoConta();
		escreverReferenciaConta();
		escreverCodigoConta();	
		escreverMensagemConta();
	...
	private void buildInformacoesFaturamento() {
		escreverSituacaoAguaEsgoto();	
	    escreverIndicadorFaturamentoSituacao();
	    escreverSituacaoEspecialFaturamento(imovel, faturamentoGrupo);
	...
	public void buildInformacoesLocalizacaoImovel() {
		builder.append(Utilitarios.completaComEspacosADireita(25, imovel.getLocalidade().getGerenciaRegional().getNome()));
		builder.append(Utilitarios.completaComEspacosADireita(25, imovel.getLocalidade().getDescricao()));
		builder.append(Utilitarios.completaComZerosEsquerda(3, faturamentoGrupo.getId()));
		builder.append(Utilitarios.completaComZerosEsquerda(7, rota.getCodigo()));
	...
	private void buildDadosCobranca() {
		escreverDadosBancarios();
	    escreverDadosCobranca();
	    escreverCodigoDebitoAutomatico();
	    escreverDataEmissaoDocumentoCobranca();
