...
@Named
public class CarregarImoveisArquivoLeitura extends AbstractItemReader {
    ...
    private Queue<MovimentoRoteiroEmpresa> imoveis = new ArrayDeque<MovimentoRoteiroEmpresa>();
...
//        
//    	List<MovimentoRoteiroEmpresa> lista = rotaBO.imoveisParaArquivoLeitura(idRota, firstItem, numItems);
//    	
